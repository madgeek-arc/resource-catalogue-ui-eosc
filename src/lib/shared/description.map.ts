...
export const providerDescMap = new Map()
  ...
  .set('nodeDesc', {mandatory: true, label: 'Node', placeholder: 'Select node...', desc: 'The node in which the Provider belongs to.'})
...
export const catalogueDescMap = new Map()
  ...
  .set('nodeDesc', {mandatory: true, label: 'Node', placeholder: 'Select node...', desc: 'The node in which the Catalogue belongs to.'})
